...
Widget networkImage(
  ...
  final imageUrls = urls ?? [url];
  final initialPage = imageUrls.indexOf(url);
...
Widget errorWidget() => const Icon(FontAwesomeIcons.exclamation);

Widget noImageWidget(double size, Color? color) => Icon(
